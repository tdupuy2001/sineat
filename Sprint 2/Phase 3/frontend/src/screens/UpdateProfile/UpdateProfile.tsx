            ...
            <div className="cont-signIn">
              ...
              {/* {loginMessage && (<Alert severity={loginMessageType}>
                {loginMessage}
                  ...
                  <TextField required className="text-field" sx={{ m: 1, width: '80%' }} id="outlined-basic" label="Nom d'utilisateur" variant="outlined" value={usernameLink} onChange={e => setUsername(e.target.value)}/>
