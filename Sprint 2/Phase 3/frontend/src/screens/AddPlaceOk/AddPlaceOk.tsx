  ...
  return (
    <div className='cont-main'>
      ...
      <div className='content-AddPlace'>
        ...
        <h2 className='thankYouTitle-ThankYouPage'>Merci d'avoir ajouté l'établissement !</h2>
      <p className='thankYouMessage-ThankYouPage'>Votre établissement a été ajouté avec succès.</p>
      <div>
        <Link to="/news">
          <button className='button-ThankYouPage'>Aller voir le fil d'actualité</button>
        </Link>
        <Link to="/map">
